...
call s:register_mapping('ShowAllBookmarks',  '-a')
call s:register_mapping('ToggleBookmark',    '-m')
call s:register_mapping('Annotate',          '-i')
call s:register_mapping('NextBookmark',      '-n')
call s:register_mapping('PrevBookmark',      '-p')
call s:register_mapping('ClearBookmarks',    '-c')
call s:register_mapping('ClearAllBookmarks', '-x')
